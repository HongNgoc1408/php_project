...
if (isset($_GET['delete'])) {
    ...
    header('location:list_orders_completed.php');
    exit();
}
...
<title>List Orders Completed</title>
</head>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Danh sách đơn hàng đã hoàn thành</h1>
    ...
    <script>
        $(document).ready(function () {
            $('#deleteConfirmationModal').on('show.bs.modal', function (event) {
                ...
                var deleteLink = 'list_orders_completed.php?delete=' + Id;
