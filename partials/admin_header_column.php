    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="list_orders_pending.php">Đơn hàng đang chờ xử lý</a>
                <a class="collapse-item" href="list_orders_cancel.php">Đơn hàng đã bị hủy</a>
                <a class="collapse-item" href="list_orders_checked.php">Đơn hàng đã duyệt</a>
                <a class="collapse-item" href="list_orders_transport.php">Đơn hàng đang vận chuyển</a>
                <a class="collapse-item" href="list_orders_completed.php">Đơn hàng đã hoàn thành</a>
            </div>
        </div>
    </li>
